...
from ...core.config import ProjectConfig, load_config, DebuggerAgentConfig
...
class DebuggerAgent(BaseAgent):
    ...
    def __init__(self, mal: Optional[MAL] = None, config: Optional[ProjectConfig] = None):
        super().__init__(agent_id="debugger", agent_name="Debugger Agent", config=config)
        ...
        self.include_code_examples = debugger_config.include_code_examples if debugger_config else True
        self.max_context_lines = debugger_config.max_context_lines if debugger_config else 50
    ...
    def get_commands(self) -> List[Dict[str, str]]:
        ...
        commands.extend([
            ...
            {"command": "*analyze-error", "description": "Analyze error message and stack trace"},
    ...
    async def debug_command(
        ...
        return {
            ...
            "fix_examples": analysis.get("fix_examples", []) if self.include_code_examples else []
        }
