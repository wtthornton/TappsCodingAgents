...
class DockerfileValidator:
    ...
    def validate_dockerfile(self, dockerfile: Path) -> dict[str, Any]:
        ...
        for pattern in secret_patterns:
            if re.search(pattern, content, re.IGNORECASE):
                ...
                suggestions.append("Use environment variables or secrets management instead")
    ...
    def review_file(self, file_path: Path, code: str) -> dict[str, Any]:
        ...
        if file_path.name in ['Dockerfile', 'Dockerfile.prod', 'Dockerfile.dev'] or \
           file_path.name.startswith('Dockerfile.'):
