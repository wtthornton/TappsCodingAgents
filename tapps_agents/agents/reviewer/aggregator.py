...
class QualityAggregator:
    ...
    def aggregate_service_scores(self, service_results: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    def compare_services(self, service_results: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for metric in all_metrics:
            ...
            reverse = not metric.startswith("complexity")  # Complexity is lower-is-better
            ...
            metrics_comparison.append({
                ...
                "range": {
                    "min": min(val for _, val in service_values) if service_values else 0.0,
                    "max": max(val for _, val in service_values) if service_values else 0.0,
                    "average": sum(val for _, val in service_values) / len(service_values) if service_values else 0.0
                }
            })
