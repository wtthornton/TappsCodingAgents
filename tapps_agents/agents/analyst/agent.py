...
class AnalystAgent(BaseAgent):
    ...
    def get_commands(self) -> List[Dict[str, str]]:
        ...
        return base_commands + [
            {"command": "*gather-requirements", "description": "Gather requirements from description or stakeholder input"},
            {"command": "*analyze-stakeholders", "description": "Analyze stakeholders and their needs"},
            {"command": "*research-technology", "description": "Research technology options for a requirement"},
            {"command": "*estimate-effort", "description": "Estimate effort and complexity for a feature"},
            {"command": "*assess-risk", "description": "Assess risks for a feature or project"},
            {"command": "*competitive-analysis", "description": "Perform competitive analysis"},
        ]
...
Format as structured JSON."""
    ...
    async def _research_technology(
        ...
        if criteria is None:
            criteria = ["performance", "scalability", "ease_of_use", "community_support"]
