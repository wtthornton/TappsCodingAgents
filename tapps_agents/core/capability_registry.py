...
class CapabilityRegistry:
    ...
    def get_capability(self, capability_id: str) -> Optional[CapabilityMetric]:
        """
    ...
    def update_capability_metrics(
        ...
        """
        if capability_id not in self.metrics:
            logger.warning(f"Capability {capability_id} not registered, creating default")
            self.register_capability(capability_id, "unknown", initial_quality=quality_score or 0.5)
