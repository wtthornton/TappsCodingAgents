...
class LearningAwareMixin:
    ...
    def optimize_prompt(self, base_prompt: str, context: Optional[str] = None) -> str:
        """
    ...
    def get_capability_metrics(self, capability_id: str) -> Optional[Dict[str, Any]]:
        """
        ...
        return {
            ...
            "last_improved": metric.last_improved.isoformat() if metric.last_improved else None,
