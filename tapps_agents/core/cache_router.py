...
from .hardware_profiler import HardwareProfiler, CacheOptimizationProfile
...
class CacheAdapter(Protocol):
    ...
    def get(self, request: CacheRequest) -> Optional[CacheResponse]:
        """Get cached entry."""
        ...
...
class TieredContextAdapter:
    ...
    def __init__(self, context_manager: ContextManager, optimization_profile: CacheOptimizationProfile):
...
class Context7KBAdapter:
    ...
    def __init__(self, kb_cache: KBCache, optimization_profile: CacheOptimizationProfile):
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_entries": sum(len(lib.get("topics", {})) for lib in index.libraries.values())
            }
        except Exception:
...
class RAGKnowledgeAdapter:
    ...
    def __init__(self, knowledge_base: SimpleKnowledgeBase, optimization_profile: CacheOptimizationProfile):
    ...
    def get(self, request: CacheRequest) -> Optional[CacheResponse]:
        ...
        if chunks:
            ...
            context = self.knowledge_base.get_context(
                query=request.query,
                max_length=request.kwargs.get("max_length", 2000)
            )
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "domain": self.knowledge_base.domain
            }
        except Exception:
            return {"status": "available"}
...
class CacheRouter:
    ...
    def __init__(
        ...
        optimization_profile: Optional[CacheOptimizationProfile] = None
    ):
        self.hardware_profiler = HardwareProfiler()
        self.optimization_profile = optimization_profile or self.hardware_profiler.get_optimization_profile()
    ...
    def get_adapter(self, cache_type: CacheType) -> Optional[CacheAdapter]:
        """Get adapter for cache type."""
        return self.adapters.get(cache_type)
    
    def route_get(self, request: CacheRequest) -> Optional[CacheResponse]:
