...
class FallbackStrategy:
    ...
    def should_use_background_agent(
        ...
        default_for = nuc_optimization.get("background_agents", {}).get("default_for", [])
    ...
    def get_background_agent_for_task(self, task_name: str) -> Optional[str]:
        """
        ...
        if self.resource_monitor:
            ...
            if metrics.is_high_usage():
                recommendations.append(
                    f"Current resource usage is high - consider using Background Agents"
                )
