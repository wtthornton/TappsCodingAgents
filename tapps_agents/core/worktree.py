...
class WorktreeManager:
    ...
    def __init__(self, base_path: Path, worktree_base: Optional[Path] = None):
        """
        ...
        self.worktree_base = worktree_base or self.base_path / ".tapps-agents" / "worktrees"
            ...
            try:
                ...
                if keep_active:
                    ...
                    if result.stdout.strip():
                        logger.info(f"Skipping worktree {agent_id} (has uncommitted changes)")
                        continue
