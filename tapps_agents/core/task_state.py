...
class TaskStateManager:
    ...
    VALID_TRANSITIONS = {
        ...
        TaskState.RUNNING: {TaskState.CHECKPOINTED, TaskState.PAUSED, TaskState.COMPLETED, TaskState.FAILED},
    ...
    def transition(self, new_state: TaskState, reason: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> bool:
        """
    ...
    def _record_transition(self, state: TaskState, reason: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None):
    ...
    def can_resume(self) -> bool:
        ...
        """
        return self.current_state in {TaskState.PAUSED, TaskState.CHECKPOINTED, TaskState.FAILED}
