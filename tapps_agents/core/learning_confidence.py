    ...
    def combine_confidence(
        ...
        if learned_confidence >= 0.8:
            ...
            combined = (
                ...
                best_practice_confidence * (1.0 - LearningConfidenceCalculator.WEIGHT_LEARNED_HIGH)
            )
            logger.debug(
            ...
            combined = (
                learned_confidence * (1.0 - LearningConfidenceCalculator.WEIGHT_BEST_PRACTICE_HIGH) +
                best_practice_confidence * LearningConfidenceCalculator.WEIGHT_BEST_PRACTICE_HIGH
            )
            logger.debug(
