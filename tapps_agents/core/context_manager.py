...
class ContextCache:
    ...
    def get(self, key: str, ttl: int) -> Optional[Dict[str, Any]]:
        """
...
class ContextManager:
    ...
    def __init__(self, cache_size: int = 100):
        ...
        self.caches: Dict[ContextTier, ContextCache] = {
            tier: ContextCache(max_size=cache_size)
    ...
    def _generate_cache_key(self, file_path: Path, tier: ContextTier, include_related: bool) -> str:
    ...
    def clear_cache(self, tier: Optional[ContextTier] = None):
        """
