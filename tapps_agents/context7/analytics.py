...
class Analytics:
    ...
    def __init__(self, cache_structure: CacheStructure, metadata_manager: MetadataManager):
        """
    ...
    def _save_metrics(self):
        ...
        try:
            with open(metrics_file, 'w', encoding='utf-8') as f:
                yaml.safe_dump(self.metrics, f, default_flow_style=False, sort_keys=False)
        except Exception:
            pass
    ...
    def get_cache_metrics(self) -> CacheMetrics:
        ...
        for library, lib_data in index.libraries.items():
        ...
        hit_rate = (cache_hits_count / total_requests * 100) if total_requests > 0 else 0.0
    ...
    def get_library_metrics(self, library: str) -> Optional[LibraryMetrics]:
        """
    ...
    def get_status_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "top_libraries": [
                m.to_dict() for m in self.get_top_libraries(5)
            ]
        }
