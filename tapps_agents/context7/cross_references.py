...
class CrossReferenceManager:
    ...
    def __init__(self, cache_structure):
        ...
        self._cross_refs: Dict[str, List[CrossReference]] = {}  # "library/topic" -> [refs]
    ...
    def _load_topic_index(self, topic: str) -> Optional[TopicIndex]:
    ...
    def _save_topic_index(self, topic_index: TopicIndex):
        ...
        with open(index_file, "w", encoding="utf-8") as f:
            yaml.dump(topic_index.to_dict(), f, default_flow_style=False, sort_keys=False)
    ...
    def add_cross_reference(
        ...
        existing = next(
            (
                ref for ref in self._cross_refs[key]
                if ref.target_library == target_library and ref.target_topic == target_topic
            ),
            None
        )
    ...
    def auto_discover_cross_references(
        self,
        library: str,
        topic: str,
        content: str
    ...
    def get_topic_index(self, topic: str) -> Optional[TopicIndex]:
        """
    ...
    def remove_cross_reference(
        ...
        self._cross_refs[key] = [
            ref for ref in refs
            if not (ref.target_library == target_library and ref.target_topic == target_topic)
        ]
