...
from .models import Workflow, WorkflowType, WorkflowStep, WorkflowSettings
...
class PresetLoader:
    ...
    def get_preset_name(self, alias: str) -> Optional[str]:
        """
    ...
    def load_preset(self, alias: str) -> Optional[Workflow]:
        """
    ...
    def find_preset_by_intent(self, intent: str) -> Optional[str]:
        """
        ...
        keywords = {
            ...
            "quick-fix": ["hotfix", "urgent", "quick fix", "emergency", "patch", "critical"],
        }
