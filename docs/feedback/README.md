...
2. Include the command output or a short summary in your feedback (e.g. overall health, subsystem status, usage at a glance).
3. This makes feedback actionable and comparable across sessions. Place feedback docs in `docs/feedback/` or `docs/archive/feedback/` per [docs/archive/README.md](../archive/README.md).
