...
- `help` - See agent documentation
- `filesystem` - See agent documentation
- `git` - See agent documentation
- `analysis` - See agent documentation
...
- `feature` - See agent documentation
- `description` - See agent documentation
- `filesystem` - See agent documentation
- `git` - See agent documentation
- `analysis` - See agent documentation
- `context7` - See agent documentation
...
- `help` - See agent documentation
- `lint` - See agent documentation
- `review` - See agent documentation
- `score` - See agent documentation
- `duplication` - See agent documentation
