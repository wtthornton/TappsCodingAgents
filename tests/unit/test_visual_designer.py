...
from tapps_agents.agents.designer.visual_designer import (
    VisualDesignerAgent, IterativeRefinement, IterationResult, RefinementConfig
)
...
class TestIterativeRefinement:
    ...
    def test_should_continue_iteration_quality_met(self):
        ...
        refinement = IterativeRefinement(
            config=RefinementConfig(quality_threshold=0.8)
        )
    ...
    def test_should_continue_iteration_improving(self):
        ...
        refinement.iteration_history.append(IterationResult(
            iteration=1,
    ...
    def test_get_refinement_summary_with_iterations(self):
        ...
        assert abs(summary["quality_improvement"] - 0.2) < 0.01  # Floating point comparison
...
class TestVisualDesignerAgent:
    ...
    def agent(self):
        ...
        with patch('tapps_agents.agents.designer.visual_designer.DesignerAgent.__init__'):
    ...
    async def test_visual_design_success(self, agent):
        ...
        agent._design_ui = AsyncMock(return_value={
            "type": "ui_design",
