...
from tapps_agents.core.visual_feedback import (
    ...
    RenderingMode, VisualElementType
)
...
class TestVisualFeedbackCollector:
    ...
    def test_initialization_default_profile(self):
        ...
        assert collector.rendering_mode in [RenderingMode.LIGHTWEIGHT, RenderingMode.STANDARD, RenderingMode.FULL]
    ...
    def test_initialization_workstation_profile(self):
        ...
        collector = VisualFeedbackCollector(hardware_profile=HardwareProfile.WORKSTATION)
...
class TestVisualAnalyzer:
    ...
    def test_initialization(self):
        ...
        assert analyzer.rendering_mode in [RenderingMode.LIGHTWEIGHT, RenderingMode.STANDARD, RenderingMode.FULL]
