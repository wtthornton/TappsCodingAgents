...
class TestCheckpointManager:
    ...
    def test_hardware_aware_intervals(self, temp_dir):
        ...
        nuc_manager = CheckpointManager(storage_dir=temp_dir, hardware_profile=HardwareProfile.NUC)
        assert nuc_manager.checkpoint_interval == 30
        
        workstation_manager = CheckpointManager(storage_dir=temp_dir, hardware_profile=HardwareProfile.WORKSTATION)
