...
from tapps_agents.context7.staleness_policies import StalenessPolicy, StalenessPolicyManager
...
class TestStalenessPolicyManager:
    ...
    def test_is_entry_stale_fresh(self, manager):
        ...
        assert manager.is_entry_stale("react", last_updated, reference_date=now) is False
    ...
    def test_is_entry_stale_critical_library(self, manager):
        ...
        assert manager.is_entry_stale("jwt-auth", last_updated, reference_date=now) is True
    ...
    def test_is_entry_stale_with_explicit_type(self, manager):
        ...
        assert manager.is_entry_stale("some-lib", last_updated, library_type="critical", reference_date=now) is True
