...
from tapps_agents.context7.metadata import (
    MetadataManager,
    LibraryMetadata,
    CacheIndex
)
...
class TestMetadataManager:
    ...
    def test_save_and_load_cache_index(self, metadata_manager):
        ...
        original_index.libraries = {
            "react": {
                "context7_id": "/facebook/react",
                "topics": {
                    "hooks": {"cached_at": "2024-01-01T00:00:00Z"}
                }
            },
            "vue": {
                "context7_id": "/vuejs/vue",
                "topics": {
                    "components": {"cached_at": "2024-01-01T00:00:00Z"}
                }
            }
        }
    ...
    def test_update_cache_index(self, metadata_manager):
        ...
        metadata_manager.update_cache_index("react", "hooks", context7_id="/facebook/react")
    ...
    def test_update_cache_index_remove(self, metadata_manager):
        ...
        index = metadata_manager.load_cache_index()
        assert index.total_entries == 0
        assert "react" not in index.libraries or "hooks" not in index.libraries.get("react", {}).get("topics", {})
