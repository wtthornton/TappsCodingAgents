...
class TestRefreshQueue:
    ...
    def test_add_task_duplicate_updates(self, queue):
        task1 = queue.add_task("react", "hooks", priority=5)
        task2 = queue.add_task("react", "hooks", priority=8)
    ...
    def test_get_next_task_oldest_first_same_priority(self, queue):
        task1 = queue.add_task("lib1", "topic1", priority=5)
        task2 = queue.add_task("lib2", "topic2", priority=5)
    ...
    def test_queue_stale_entries(self, queue):
        ...
        entries = [
            ...
            },
            {
                "library": "angular",
                "topic": "routing",
                "last_updated": (now - timedelta(days=40)).isoformat() + "Z"  # Very stale
            }
        ]
        ...
        entries = [
            {
                "library": "react",
                "topic": "hooks",
                "last_updated": (now - timedelta(days=50)).isoformat() + "Z"  # Very stale
            },
            {
                "library": "vue",
                "topic": "components",
                "last_updated": (now - timedelta(days=35)).isoformat() + "Z"  # Moderately stale
            }
        ]
        ...
        entries = [
            {
                "library": "jwt-auth",
                "topic": "tokens",
                "last_updated": (now - timedelta(days=8)).isoformat() + "Z"  # Stale for critical
            }
        ]
