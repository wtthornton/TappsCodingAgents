...
import pytest
from tapps_agents.context7.fuzzy_matcher import FuzzyMatcher, FuzzyMatch
...
class TestFuzzyMatcher:
    ...
    def test_find_matching_library_max_results(self, matcher_low_threshold):
        ...
        matches = matcher_low_threshold.find_matching_library("react", libraries, max_results=2)
    ...
    def test_find_matching_entry_partial_match(self, matcher_low_threshold):
        entries = [("react", "hooks"), ("react-dom", "rendering"), ("vue", "components")]
    ...
    def test_find_matching_entry_library_only_match(self, matcher_low_threshold):
        ...
        matches = matcher_low_threshold.find_matching_entry("react", "unknown-topic", entries)
