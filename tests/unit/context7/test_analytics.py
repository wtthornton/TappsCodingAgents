...
from tapps_agents.context7.metadata import MetadataManager, LibraryMetadata
...
class TestAnalytics:
    ...
    def test_get_cache_metrics_with_data(self, analytics, metadata_manager, cache_structure):
        # Add some metadata
    ...
    def test_metrics_persistence(self, temp_cache_root, cache_structure, metadata_manager):
