...
from tapps_agents.core.cache_router import CacheType, CacheRequest, CacheResponse
...
class TestUnifiedCacheInterface:
    ...
    def test_hit_miss_statistics(self, unified_cache, mock_context_manager):
        ...
        # Cache hit
        mock_context_manager.get_context.return_value = {"content": "test", "cached": True}
        unified_cache.get(
            cache_type=CacheType.TIERED_CONTEXT,
            key="test.py",
            tier=ContextTier.TIER1
    ...
    def test_auto_hardware_detection(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
        ...
        with patch('tapps_agents.core.unified_cache.HardwareProfiler') as mock_profiler_class:
            ...
            mock_profiler.get_current_resource_usage.return_value = {"cpu": 50.0, "memory": 60.0}
