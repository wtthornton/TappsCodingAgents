...
from tapps_agents.core.config import MALConfig, CloudProviderConfig
...
class TestCloudMAL:
    ...
    async def test_anthropic_generate_success(self, mal_config):
        ...
        with patch("httpx.AsyncClient.post") as mock_post:
            ...
            result = await mal._anthropic_generate("Test prompt", "claude-3-sonnet-20240229")
    ...
    async def test_fallback_ollama_to_anthropic(self, mal_config):
        ...
        # Mock Ollama failure
        with patch.object(MAL, "_ollama_generate", side_effect=ConnectionError("Ollama unavailable")):
    ...
    async def test_fallback_provider_order(self, mal_config):
        ...
        with patch.object(MAL, "_ollama_generate", side_effect=ConnectionError("Ollama unavailable")):
            ...
            with patch.object(MAL, "_anthropic_generate", side_effect=ConnectionError("Anthropic unavailable")):
                # Mock OpenAI success
                mock_response = {
