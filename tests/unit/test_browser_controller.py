...
class TestScreenshotOptions:
    ...
    def test_custom_options(self):
        ...
        options = ScreenshotOptions(full_page=True, clip=clip, quality=80, timeout=60.0)
...
class TestInteractionEvent:
    ...
    def test_click_event(self):
        ...
        event = InteractionEvent(event_type="click", selector="#button")
    ...
    def test_event_metadata(self):
        ...
        event = InteractionEvent(
            event_type="click", selector="#button", metadata={"test": True, "value": 42}
        )
