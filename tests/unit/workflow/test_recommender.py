...
from tapps_agents.workflow.recommender import WorkflowRecommender, WorkflowRecommendation
from tapps_agents.workflow.detector import WorkflowTrack, ProjectType
...
class TestWorkflowRecommender:
    ...
    def test_recommend_workflow_loaded(self, temp_project):
        ...
        assert recommendation.workflow_file is not None or len(recommendation.alternative_workflows) > 0
    ...
    def test_recommend_no_workflows_dir(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            assert isinstance(recommendation, WorkflowRecommendation)
            assert recommendation.track in [WorkflowTrack.QUICK_FLOW, WorkflowTrack.BMAD_METHOD, WorkflowTrack.ENTERPRISE]
