...
class TestDesignerAgent:
    ...
    async def test_design_api_success(self, designer):
        ...
        result = await designer.run("design-api", requirements="Test API", api_type="REST")
    ...
    async def test_design_ui(self, designer):
        ...
        result = await designer.run("design-ui", feature_description="Test feature", user_stories=["Story1"])
    ...
    async def test_create_wireframe(self, designer):
        ...
        result = await designer.run("create-wireframe", screen_description="Test screen", wireframe_type="page")
    ...
    async def test_define_design_system(self, designer):
        ...
        result = await designer.run("define-design-system", project_description="Test project")
