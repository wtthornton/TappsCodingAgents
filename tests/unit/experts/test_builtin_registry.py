...
class TestBuiltinExpertRegistry:
    ...
    def test_security_expert_exists(self):
        ...
        security_expert = next(
            (e for e in experts if e.expert_id == "expert-security"),
            None
        )
    ...
    def test_is_technical_domain(self):
        ...
        assert BuiltinExpertRegistry.is_technical_domain("performance-optimization") is True
    ...
    def test_all_builtin_experts_have_required_fields(self):
        ...
        for expert in experts:
            ...
            assert expert.primary_domain, f"Expert missing primary_domain: {expert.expert_id}"
            assert isinstance(expert.rag_enabled, bool), f"Expert rag_enabled not bool: {expert.expert_id}"
            assert isinstance(expert.fine_tuned, bool), f"Expert fine_tuned not bool: {expert.expert_id}"
