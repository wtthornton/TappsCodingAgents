...
from tapps_agents.core.context_manager import ContextManager, ContextCache
...
""")
    ...
    async def test_get_context_caching(self, manager, sample_python_file):
        ...
        context1 = manager.get_context(sample_python_file, ContextTier.TIER1, use_cache=True)
        context2 = manager.get_context(sample_python_file, ContextTier.TIER1, use_cache=True)
    ...
    def test_get_context_text_text_format(self, manager, sample_python_file):
        ...
        text = manager.get_context_text(sample_python_file, ContextTier.TIER1, format="text")
    ...
    def test_get_context_text_markdown_format(self, manager, sample_python_file):
        ...
        text = manager.get_context_text(sample_python_file, ContextTier.TIER1, format="markdown")
    ...
    def test_get_context_text_json_format(self, manager, sample_python_file):
        ...
        text = manager.get_context_text(sample_python_file, ContextTier.TIER1, format="json")
