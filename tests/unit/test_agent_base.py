...
class TestBaseAgent:
    ...
    @pytest.mark.asyncio
    async def test_activate_loads_domain_config(self, temp_project_dir: Path, base_agent):
    ...
    @pytest.mark.asyncio
    async def test_activate_loads_customizations(self, temp_project_dir: Path, base_agent):
