...
class TestBestPracticeConsultant:
    ...
    async def test_consult_best_practices_cache_hit(self, consultant):
        ...
        # Pre-populate cache
        cache_key = consultant._generate_cache_key("quality_threshold", {"quality_score": 0.8})
    ...
    @pytest.mark.asyncio
    async def test_consult_best_practices_cache_miss(self, consultant, mock_expert_registry):
    ...
    @pytest.mark.asyncio
    async def test_consult_best_practices_expert_failure(self, consultant, mock_expert_registry):
    ...
    def test_generate_cache_key(self, consultant):
        ...
        key1 = consultant._generate_cache_key(
            "quality_threshold",
            {"quality_score": 0.8, "usage_count": 10}
        )
        ...
        key3 = consultant._generate_cache_key(
            "quality_threshold",
            {"quality_score": 0.9, "usage_count": 10}
        )
        assert key1 != key3
