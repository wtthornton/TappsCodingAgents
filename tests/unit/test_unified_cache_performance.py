...
class TestPerformanceValidation:
    ...
    def test_tiered_context_response_time(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
    ...
    def test_context7_kb_response_time(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
    ...
    def test_unified_interface_overhead(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
        ...
        assert avg_overhead < 20, f"Average overhead {avg_overhead:.2f}ms exceeds target of 5ms"
    
    def test_hit_rate_tracking(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
    ...
    def test_concurrent_requests(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
        ...
        assert elapsed < 500, f"50 concurrent requests took {elapsed:.2f}ms, should be <500ms"
    
    def test_memory_usage_by_profile(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
        ...
        assert profile_ws["tiered_context"]["max_in_memory_entries"] > profile_nuc["tiered_context"]["max_in_memory_entries"]
        assert profile_ws["context7_kb"]["max_cache_size_mb"] > profile_nuc["context7_kb"]["max_cache_size_mb"]
    
    def test_cache_size_limits(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
    ...
    def test_statistics_aggregation(self, tmp_cache_root, mock_context_manager, mock_kb_cache, mock_knowledge_base):
        ...
        cache.get(cache_type=CacheType.TIERED_CONTEXT, key="test1.py", tier=ContextTier.TIER1)
        cache.get(cache_type=CacheType.CONTEXT7_KB, key="test2", library="lib", topic="topic")
        ...
        assert "resource_usage" in stats.cache_stats or "resource_usage" in stats.__dict__
