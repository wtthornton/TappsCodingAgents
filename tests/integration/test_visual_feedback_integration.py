...
from tapps_agents.core.visual_feedback import (
    ...
    VisualFeedback, VisualElement, VisualElementType
)
from tapps_agents.core.browser_controller import BrowserController, BrowserType
...
class TestVisualFeedbackIntegration:
    ...
    def test_visual_analysis_with_browser_content(self):
        ...
        accessibility_metrics = analyzer.analyze_accessibility(
            elements,
            html_content="<html><body><button>Button</button></body></html>"
        )
    ...
    async def test_hardware_aware_rendering(self):
        ...
        refinement_ws = IterativeRefinement(hardware_profile=HardwareProfile.WORKSTATION)
        assert refinement_ws.visual_analyzer.rendering_mode.value in ["standard", "full"]
