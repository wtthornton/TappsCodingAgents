"""
Integration tests for WorktreeManager branch cleanup functionality.

These tests use real git commands (subprocess) to validate _delete_branch and
remove_worktree(delete_branch=). They belong in integration/ rather than unit/
because they invoke real `git` and exercise the full WorktreeManager + git interaction.
"""
