...
class TestLearningBestPracticesIntegration:
    ...
    @pytest.mark.asyncio
    async def test_agent_learner_with_expert_registry(self, capability_registry, hardware_profile, mock_expert_registry):
    ...
    @pytest.mark.asyncio
    async def test_learn_from_task_with_decision_engine(self, capability_registry, hardware_profile, mock_expert_registry):
    ...
    @pytest.mark.asyncio
    async def test_decision_engine_uses_learned_experience(self, capability_registry, hardware_profile, mock_expert_registry):
    ...
    @pytest.mark.asyncio
    async def test_decision_engine_falls_back_to_best_practice(self, capability_registry, hardware_profile, mock_expert_registry):
    ...
    @pytest.mark.asyncio
    async def test_decision_engine_cache_performance(self, capability_registry, hardware_profile, mock_expert_registry):
        ...
        decision1 = await learner.decision_engine.make_decision(
        ...
        decision2 = await learner.decision_engine.make_decision(
            decision_type="quality_threshold",
            learned_data={
                "usage_count": 5,
                "success_rate": 0.5,
