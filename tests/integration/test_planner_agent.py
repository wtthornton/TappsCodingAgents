...
3. Update documentation"""
    ...
    @pytest.mark.asyncio
    async def test_planner_plan_command_missing_description(self, mock_mal_with_responses):
    ...
    @pytest.mark.asyncio
    async def test_planner_create_story_command(self, mock_mal_with_responses, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_planner_create_story_with_epic(self, mock_mal_with_responses, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_planner_create_story_with_priority(self, mock_mal_with_responses, tmp_path: Path):
        ...
        priority = "high"
        result = await planner.run("create-story", description=description, priority=priority)
        
        assert result["type"] == "story"
        assert result["metadata"]["priority"] == priority
    
    @pytest.mark.asyncio
    async def test_planner_create_story_missing_description(self, mock_mal_with_responses):
    ...
    @pytest.mark.asyncio
    async def test_planner_list_stories_empty(self, mock_mal_with_responses, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_planner_list_stories_with_files(self, mock_mal_with_responses, tmp_path: Path):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_planner_list_stories_filter_by_epic(self, mock_mal_with_responses, tmp_path: Path):
...
""")
        ...
        story2.write_text("""# Checkout Story
...
""")
    ...
    @pytest.mark.asyncio
    async def test_planner_list_stories_filter_by_status(self, mock_mal_with_responses, tmp_path: Path):
